...
mode_path = 'D:\Ditto\Kuliah\Matkul\Semester 5\ML\Pertemuan 4\Tugas_A_11605'
model=os.path.join(mode_path, 'GBT_heartDisease_mode.pkl')
...
input_data =[[input_sex_F, input_sex_M, input_cpain_ASY, input_cpain_ATA, input_cpain_NAP, input_cpain_TA,
